...
class hrboardForm(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title("Pay Roll Systen/HR-Dashboard")
        ...
        self.label = tk.Label(self.overlay_frame, text="DASHBOARD", font=("Arial", 14, "bold"), fg="white", bg="blue")
        self.label.place(relx=0.5, rely=0.5, anchor="center")

        self.header_frame = tk.Frame(self,relief=tk.RIDGE,bg="black")
        ...
        self.logo = tk.Label(self.logo_frame, borderwidth=0, foreground="yellow", text="HUMAN RESOURCE", width=34, background="blue", font=("Times New Roman",  12, "bold"), anchor="w")
        self.logo.pack()
        ...
        self.delete_edit_button = tk.Button(self.link_frame, borderwidth=0, foreground="white", text="Delete", width=20, background="blue", font=("Times New Roman",  12, "bold"), anchor="w", command=self.delete)
    ...
    # def create_landing_page(self):
        self.landing_page_frame = tk.Frame(self, bg="black")
        ...
        self.lab = tk.Label(self.header_frame, text="PAY-ROLL SYSTEM DASHBOARD", font=("Arial", 34, "bold"), fg="white", bg="black")
        self.lab.place(x=170, y=20)

        self.square_frame_1 = tk.Frame(self.landing_page_frame, width=200, height=200, bg="lightgreen")
        self.square_frame_1.place(x=0, y=0)
        self.square_frame_1.bind("<Enter>", lambda event: self.change_bg_color(self.square_frame_1, "pink"))
        self.square_frame_1.bind("<Leave>", lambda event: self.change_bg_color(self.square_frame_1, "lightgreen"))
        ...
        self.button_1 = tk.Button(self.square_frame_1, text="View Employees >>")
    ...
    def open_hr_table(self):
        webbrowser.open(hrboardForm)
